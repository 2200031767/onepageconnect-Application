...
function submitForm(formData) {
  ...
  fetch('https://oqkyavj82m.execute-api.us-east-1.amazonaws.com/dev/submit', { // URL that represents the backend API endpoint to which the form data is going to be sent
    method: 'POST',
    headers: {
